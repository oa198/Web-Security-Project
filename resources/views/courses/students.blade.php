...
<div class="py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-6">
            <div class="flex justify-between items-center">
                <h1 class="text-2xl font-semibold text-gray-900">
                    Students Enrolled in {{ $course->name ?? $course->title }}
                </h1>
        ...
        <!-- Search Form -->
        <div class="mb-6">
            <form action="{{ route('courses.students', $course->id) }}" method="GET" class="flex items-center">
                <div class="relative flex-grow">
                    <input type="text" name="search" value="{{ request('search') }}" placeholder="Search students..." class="w-full px-4 py-2 border border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    @if(request('search'))
                    <a href="{{ route('courses.students', $course->id) }}" class="absolute right-0 top-0 mt-2 mr-2 text-gray-600 hover:text-gray-800">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                {{ $student->pivot->created_at->format('M d, Y') ?? 'Unknown' }}
                            </td>
        ...
        <!-- Add Student Form for Instructors -->
        @can('update', $course)
        <div class="mt-8 bg-white shadow overflow-hidden sm:rounded-lg">
            ...
            <div class="border-t border-gray-200 px-4 py-5 sm:p-6">
                <form action="#" method="POST" class="space-y-4">
                    @csrf
                    <div>
                        <label for="student_search" class="block text-sm font-medium text-gray-700">Search Students</label>
                        <div class="mt-1 flex rounded-md shadow-sm">
                            <input type="text" name="student_search" id="student_search" class="flex-1 focus:ring-blue-500 focus:border-blue-500 block w-full min-w-0 rounded-md sm:text-sm border-gray-300" placeholder="Search by name, email, or ID">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="bg-gray-50 p-4 rounded-md text-sm text-gray-500 italic">
                            Search for students to see results here.
                        </div>
                    </div>
