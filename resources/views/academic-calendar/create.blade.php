...
<div class="py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Page Title -->
        <div class="mb-6">
            <h1 class="text-3xl font-semibold text-gray-900">Create Calendar Event</h1>
            <p class="mt-2 text-sm text-gray-600">Add a new event to the academic calendar.</p>
        </div>
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            <form action="{{ route('academic-calendar.store') }}" method="POST">
                ...
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title') }}" required class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="e.g., Spring Semester Start">
                        </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <select id="event_type" name="event_type" required class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                ...
                                <option value="class" {{ old('event_type') == 'class' ? 'selected' : '' }}>Class</option>
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="date" name="start_date" id="start_date" value="{{ old('start_date') }}" required class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        </div>
                        ...
                        <div class="col-span-1">
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input id="all_day" name="all_day" type="checkbox" value="1" {{ old('all_day') ? 'checked' : '' }} class="focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300 rounded">
                                </div>
                        ...
                        <div class="col-span-1">
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input id="is_recurring" name="is_recurring" type="checkbox" value="1" {{ old('is_recurring') ? 'checked' : '' }} class="focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300 rounded">
                                </div>
                                <div class="ml-3 text-sm">
                        ...
                        <div class="col-span-2 recurring-options" style="{{ old('is_recurring') ? '' : 'display: none;' }}">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-1 flex rounded-md shadow-sm">
                                            <input type="number" min="1" name="recurrence_interval" id="recurrence_interval" value="{{ old('recurrence_interval', 1) }}" class="focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-l-md">
                                            <span id="interval-unit" class="inline-flex items-center px-3 rounded-r-md border border-l-0 border-gray-300 bg-gray-50 text-gray-500 sm:text-sm">
                                                {{ old('recurrence_type') == 'weekly' ? 'week(s)' : (old('recurrence_type') == 'monthly' ? 'month(s)' : 'day(s)') }}
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-1 flex rounded-md shadow-sm">
                                            <input type="number" min="1" name="recurrence_end" id="recurrence_end" value="{{ old('recurrence_end', 10) }}" class="focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-l-md">
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="text" name="location" id="location" value="{{ old('location') }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="e.g., Main Campus, Building A, Room 101">
                        </div>

                        <!-- Description -->
                        <div class="col-span-2">
                            <label for="description" class="block text-sm font-medium text-gray-700">Description</label>
                            <textarea id="description" name="description" rows="4" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="Provide details about this event">{{ old('description') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="px-4 py-3 bg-gray-50 text-right sm:px-6 flex justify-end space-x-2">
                    <a href="{{ route('academic-calendar.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                        Cancel
                    </a>
