<aside class="fixed inset-y-0 left-0 z-10 w-64 bg-white border-r border-gray-200 shadow-sm lg:static lg:block lg:translate-x-0 -translate-x-full transform transition-transform duration-300 ease-in-out" id="sidebar">
    <div class="flex flex-col h-full">
        ...
        <nav class="flex-1 px-4 py-4 space-y-1 overflow-y-auto">
            ...
            <a href="{{ route('schedule.temp-page') }}" class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg {{ request()->routeIs('schedule.*') || request()->is('schedule-page') ? 'text-purple-700 bg-purple-50' : 'text-gray-700 hover:bg-gray-100' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3 {{ request()->routeIs('schedule.*') || request()->is('schedule-page') ? 'text-purple-500' : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a href="{{ route('financial.temp-page') }}" class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg {{ request()->routeIs('financial.*') || request()->is('financial-page') ? 'text-purple-700 bg-purple-50' : 'text-gray-700 hover:bg-gray-100' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3 {{ request()->routeIs('financial.*') || request()->is('financial-page') ? 'text-purple-500' : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <!-- Admin Dashboard link (available to all for now, you can implement role-checking later) -->
            <a href="{{ route('admin.temp-dashboard') }}" class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg {{ request()->routeIs('admin.temp-dashboard') || request()->is('admin*') ? 'text-purple-700 bg-purple-50' : 'text-gray-700 hover:bg-gray-100' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3 {{ request()->routeIs('admin.temp-dashboard') || request()->is('admin*') ? 'text-purple-500' : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
